...
- v50.4: 신규 코드 243·242(데라 친구톡 카탈로그)·241(추석기획전 탭), WEEKLY_GROUPS 앱그룹 238~243 반영, 순수앱 정규식 데이터라이즈 매칭 수정
- v50.3: 신규 추적코드 240·239·238 (가공육/등급별할인관/제철맛지도), KST 날짜 버그 수정(iso/eachDay), 회원유형 비교 가입기간

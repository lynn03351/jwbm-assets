...
(function () {
    ...
    function generateCode() {
        ...
        var fullCode = '<!DOCTYPE html>\n'
            ...
            + '        .toggle-button { width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; transition: transform 1s ease; flex-shrink: 0; }\n'
            + '        .toggle-button svg { width: 21px; height: 21px; fill: #666; }\n'
            + '        .ranking-content { position: relative; height: 176px; overflow: hidden; }\n'
            + '        .ranking-slider { position: relative; width: 100%; height: 100%; }\n'
            + '        .ranking-item { display: block; position: absolute; top: 0; left: 0; width: 100%; padding: 16px 20px; border-bottom: 1px solid #f0f0f0; text-decoration: none; color: inherit; opacity: 0; animation: rkCycle 11.25s linear infinite; animation-fill-mode: both; }\n'
            + '        .ranking-item:nth-child(1) { animation-delay: 0s; }\n'
            + '        .ranking-item:nth-child(2) { animation-delay: 2.25s; }\n'
            + '        .ranking-item:nth-child(3) { animation-delay: 4.5s; }\n'
            + '        .ranking-item:nth-child(4) { animation-delay: 6.75s; }\n'
            + '        .ranking-item:nth-child(5) { animation-delay: 9s; }\n'
            ...
            + '                2%   { transform: translateY(0); opacity: 1; }\n'
            + '                18%  { transform: translateY(0); opacity: 1; }\n'
            + '                20%, 100% { transform: translateY(min(calc(-38vw - 32px), -176px)); opacity: 0; }\n'
            + '            }\n'
            + '        }\n'
            + '    </style>\n'
            + '</head>\n'
